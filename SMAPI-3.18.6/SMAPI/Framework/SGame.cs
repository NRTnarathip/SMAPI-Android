...
namespace StardewModdingAPI.Framework
{
    ...
    internal class SGame : Game1
    {
        ...
        *********/
        ...
        public IReflectedField<Task> _newDayTaskField { get; }
        public IReflectedField<StringBuilder> _debugStringBuilderField { get; }

        private IReflectedMethod DrawTapToMoveTargetMethod { get; }
        public IReflectedMethod DrawGreenPlacementBoundsMethod { get; }
        ...
        *********/
            ...
            : base(playerIndex, instanceIndex)
        {
            ...
            this._newDayTaskField = Reflection.GetField<Task>(typeof(Game1), "_newDayTask");
            this._debugStringBuilderField = Reflection.GetField<StringBuilder>(typeof(Game1), "_debugStringBuilder");
            this.DrawTapToMoveTargetMethod = Reflection.GetMethod(this, "DrawTapToMoveTarget");
            this.DrawGreenPlacementBoundsMethod = Reflection.GetMethod(this, "DrawGreenPlacementBounds");
        }
        ...
        *********/
        ...
        //!!!! this.Monitor it's NULL!! please check in SGame.ctor();
        ...
        protected override void _draw(GameTime gameTime, RenderTarget2D target_screen)
        {
            ...
            catch (Exception ex)
            {
                ...
                this.Monitor.Log($"error detail: {ex.StackTrace}", LogLevel.Error);
                this.Monitor.Log($"error detail: {ex.TargetSite}", LogLevel.Error);
...
#nullable disable
        ...
        private void DrawImpl(GameTime gameTime, RenderTarget2D target_screen)
        {
            ...
            //fix fix. access private field with Reflection
            if (this._newDayTaskField.GetValue() != null || this.isLocalMultiplayerNewDayActive)
            {
            ...
            else
            {
                ...
                //this.Monitor.Log("NRT Debug error: " + Game1.spriteBatch + " , " + Game1.currentLocation);
                Game1.currentLocation.drawBackground(Game1.spriteBatch);
                //this.Monitor.Log("done call 528 528");
                ...
                if ((Game1.displayHUD || Game1.eventUp) && Game1.currentBillboard == 0 && Game1.gameMode == 3 && !Game1.freezeControls && !Game1.panMode && !Game1.HostPaused && !this.takingMapScreenshot)
                {
                    ...
                    {
                        DrawGreenPlacementBoundsMethod.Invoke();
                    }
                }
            ...
            if (Game1.debugMode)
            {
                ...
                StringBuilder sb = this._debugStringBuilderField.GetValue();
                sb.Clear();
                if (Game1.panMode)
                {
        ...
        //Original 
        private void DrawImpl_2(GameTime gameTime, RenderTarget2D target_screen)
        {
            var events = this.Events;

            Game1.showingHealthBar = false;
            //if (Game1._newDayTask != null || this.isLocalMultiplayerNewDayActive)
            if (_newDayTaskField.GetValue() != null || this.isLocalMultiplayerNewDayActive)
            {
                base.GraphicsDevice.Clear(Game1.bgColor);
                return;
            }
            ...
            if (Game1.debugMode)
            {
                ...
                Console.WriteLine("On create sb");
                sb.Clear();
                if (Game1.panMode)
                {
                    sb.Append((Game1.getOldMouseX() + Game1.viewport.X) / 64);
