...
namespace StardewModdingAPI.Framework
{
    ...
    internal class Monitor : IMonitor
    {
        ...
        *********/
        ...
        private static readonly int MaxLevelLength = Enum.GetValues(typeof(LogLevel)).Length;
        ...
        private static readonly Dictionary<ConsoleLogLevel, string> LogStrings = ((ConsoleLogLevel[])Enum.GetValues(typeof(ConsoleLogLevel))).ToDictionary((ConsoleLogLevel level) => level, (ConsoleLogLevel level) => level.ToString().ToUpper().PadRight(MaxLevelLength));
        ...
        *********/
        ...
        internal void LogUserInput(string input)
        {
            ...
            var msg = $"{prefix} $>{input}";
            this.LogFile.WriteLine(msg);

            AndroidLog.Log("LogUserInput: " + msg);
            ConsoleHook.AddLogHistory(msg);
        }
        ...
        *********/
        ...
        private void LogImpl(string source, string message, ConsoleLogLevel level)
        {
            ...
            AndroidLog.Log(fullMessage);
            ConsoleHook.AddLogHistory(fullMessage);
        }
