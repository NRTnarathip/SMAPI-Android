        ...
        public Assembly Load(IModMetadata mod, FileInfo assemblyFile, bool assumeCompatible)
        {
            ...
            foreach (AssemblyParseResult assembly in assemblies)
            {
                ...
                foreach (AssemblyNameReference reference in assembly.Definition.MainModule.AssemblyReferences)
                {
                    //fix fix
                    //it's already loaded
                    //some asm it's can't check load by MonoCecil
                    //such as StardewValley, MonoGame.Framework, StardewValley.GameData
                    ...
                    {
                        //this.Monitor.Log("Done load reference >> " + reference.Name);
                    }
                }
            ...
            {
                Monitor.Log("mod is broken code loaded and asseume complatible");
