...
namespace Nanoray.Pintail
{
    ...
    internal class NullableProxyFactory<Context> : IProxyFactory<Context>
    {
        ...
        private Func<NullableProxyFactory<Context>, IProxyManager<Context>, object, object> CreateMapDelegate(IProxyManager<Context> manager, Type inputType, Type outputType)
        {
            ...
            il.Emit(OpCodes.Call, typeof(NullableProxyFactory<Context>).GetMethod(nameof(Map),
                BindingFlags.NonPublic | BindingFlags.Instance)!.MakeGenericMethod(new Type[] { inputType, outputType }));
            ...
            //NRT
            Type delegateType = typeof(Func<NullableProxyFactory<Context>, IProxyManager<Context>, object, object>);
            return Delegate.CreateDelegate(delegateType, method) as Func<NullableProxyFactory<Context>, IProxyManager<Context>, object, object>;
        }
